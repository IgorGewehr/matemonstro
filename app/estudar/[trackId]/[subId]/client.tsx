...
export default function StudyPage() {
  ...
  return (
    <div className="space-y-6 pb-10 mm-enter">
      ...
      {sub.objectives?.length > 0 && (
        <Section title="Objetivos">
          <ul className="space-y-1.5 mm-stagger">
      ...
      {sub.keyConcepts?.length > 0 && (
        <Section title="Conceitos-chave">
          <div className="grid gap-3 mm-stagger">
      ...
      {zettelOffer && (
        ...
        >
          <div
            ...
            className="panel w-full max-w-md p-6 mm-pop"
